...
public class CustomSharedPreference {
    ...
    private static String PREFERENCE_NAME = "Visitor";
    public static String KEY_LOGIN_MOBILE = "LoginMobile";
    public static String KEY_CITY = "CityIds";
    public static String KEY_ALL_CITY = "AllCity";
    public static String KEY_VISITOR = "Visitor";

    public static String KEY_EVENT_INDUSTRY_TYPE = "EventIndustryType";
    public static String KEY_EVENT_ALL_INDUSTRY_TYPE = "EventAllIndustryType";
